		...
		<main id="main">
			...
			<section id="breadcrumbs" class="breadcrumbs">
				<div class="container">
					...
					<ol>
						...
						<li><a href="${pageContext.request.contextPath}/admin/guestbookList/1">GuestbookList</a></li>
						<li>ModifyGuestbook</li>
					</ol>
					<h2>방명록 수정</h2>
			...
			<section class="inner-page pt-4">
				<div class="container">
					<!-- 방명록 수정 -->
					<div>
						<form method="post" action="${pageContext.request.contextPath}/admin/modifyGuestbook" enctype="multipart/form-data" id="guestbookForm">
							<table class="table">
								<tr>
									<td width="20%">번호</td>
									<td width="80%"><input type="text" class="form-control" name="guestbookId" id="guestbookId" value="${guestbook.guestbookId}" readonly="readonly"></td>
								</tr>
								<tr>
									<td>날짜</td>
									<td><input type="text" class="form-control" name="guestbookDate" id="guestbookDate" value="${guestbook.guestbookDate}" readonly="readonly"></td>
								</tr>
								<tr>
									<td>작성자</td>
									<td><input type="text" class="form-control" name="guestbookWriter" id="guestbookWriter" value="${guestbook.guestbookWriter}" readonly="readonly"></td>
								</tr>
								<tr>
									<td>제목</td>
									<td><input type="text" class="form-control" name="guestbookTitle" id="guestbookTitle" value="${guestbook.guestbookTitle}"></td>
								</tr>
								<tr>
									<td>내용</td>
