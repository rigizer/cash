...
<html lang="ko">
		...
		<main id="main">
			...
			<section id="breadcrumbs" class="breadcrumbs">
				<div class="container">
					<ol>
						...
						<li>Statistics</li>
						<li>월별 일일 평균 지출 내역</li>
					</ol>
					<h2>월별 일일 평균 지출 내역</h2>
				</div>
			</section>
			<!-- End Breadcrumbs -->
			...
			<section class="inner-page pt-4">
				<div class="container">
					...
					<!-- Chart -->
					<div>
						<canvas id="averageOutOfMonthByYearChartResult"></canvas>
					</div>
				</div>
			</section>
	...
	<script>
		<!-- Chart -->
		$.ajax({
		     url:'${pageContext.request.contextPath}/admin/averageOutOfMonthByYear/' + getParam("year"),
		     type:'GET',
		     success: function(data) {
		        var ctx = document.getElementById('averageOutOfMonthByYearChartResult').getContext('2d');
		           ...
		           // The type of chart we want to create
		            ...
		            data: {
		               // 배열 형태로 작성
		                ...
		                datasets: [{
		                    label: getParam("year")+'년 월별 일일 평균 지출 내역 차트',
		                    backgroundColor: [
		                       	'rgba(255, 99, 132, 0.2)',
		                        'rgba(54, 162, 235, 0.2)',
		                        'rgba(255, 206, 86, 0.2)',
